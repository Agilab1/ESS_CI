...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="materialTable" class="table table-bordered table-striped text-center">
                    ...
                    <?php foreach ($materials as $m): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('material/delete/' . $m->material_id); ?>" onclick="return confirm('Delete?');">
